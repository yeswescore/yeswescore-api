    ...
    for (var i = 0; i < nbGames; ++i) {
      ...
      var game = new DB.Models.Game({
        ...
        infos: {
          ...
          numberOfBestSets: [3,undefined].random()
        }
      });
      ...
      if (game.status === "finished") {
        ...
        if (Math.random() > 0.5) {
          game.infos.sets = "16/"+Math.floor(Math.random() * 15)+";16/"+Math.floor(Math.random() * 15);
          game.infos.score = "2/0";
        } else {
          game.infos.sets = Math.floor(Math.random() * 15)+"/16;"+Math.floor(Math.random() * 15)+"/16";
        ...
        if (Math.random() > 0.5) {
          // 2 set
          if (Math.random() > 0.5) {
            game.infos.sets = "16/"+Math.floor(Math.random() * 15)+";"+Math.floor(Math.random() * 15)+"/"+Math.floor(Math.random() * 15);
            game.infos.score = "1/0";
          } else {
            game.infos.sets = Math.floor(Math.random() * 15)+"/16;"+Math.floor(Math.random() * 15)+"/"+Math.floor(Math.random() * 15);
            game.infos.score = "0/1";
          }
        } else {
          // 1 set
          game.infos.sets = Math.floor(Math.random() * 15)+"/"+Math.floor(Math.random() * 15);
