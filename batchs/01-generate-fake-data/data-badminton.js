  ...
  return Q.all([
    ...
    for (var i = 0; i < nbGames; ++i) {
      ...
      if (game.status === "finished") {
        ...
        if (Math.random() > 0.5) {
          game.infos.sets = "21/"+Math.floor(Math.random() * 20)+";21/"+Math.floor(Math.random() * 20);
          game.infos.score = "2/0";
        } else {
          game.infos.sets = Math.floor(Math.random() * 20)+"/21;"+Math.floor(Math.random() * 20)+"/21";
        ...
        if (Math.random() > 0.5) {
          // 2 set
          if (Math.random() > 0.5) {
            game.infos.sets = "21/"+Math.floor(Math.random() * 20)+";"+Math.floor(Math.random() * 20)+"/"+Math.floor(Math.random() * 20);
            game.infos.score = "1/0";
          } else {
            game.infos.sets = Math.floor(Math.random() * 20)+"/21;"+Math.floor(Math.random() * 20)+"/"+Math.floor(Math.random() * 20);
            game.infos.score = "0/1";
          }
        } else {
          // 1 set
          game.infos.sets = Math.floor(Math.random() * 20)+"/"+Math.floor(Math.random() * 20);
