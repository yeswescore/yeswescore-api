  ...
  return Q.all([
    ...
    for (var i = 0; i < nbGames; ++i) {
      ...
      if (game.status === "finished") {
        ...
        if (Math.random() > 0.5) {
          game.infos.sets = "15/"+Math.floor(Math.random() * 14)+";15/"+Math.floor(Math.random() * 14);
          game.infos.score = "2/0";
        } else {
          game.infos.sets = Math.floor(Math.random() * 14)+"/15;"+Math.floor(Math.random() * 14)+"/15";
        ...
        if (Math.random() > 0.5) {
          // 2 set
          if (Math.random() > 0.5) {
            game.infos.sets = "15/"+Math.floor(Math.random() * 14)+";"+Math.floor(Math.random() * 14)+"/"+Math.floor(Math.random() * 14);
            game.infos.score = "1/0";
          } else {
            game.infos.sets = Math.floor(Math.random() * 14)+"/15;"+Math.floor(Math.random() * 14)+"/"+Math.floor(Math.random() * 14);
            game.infos.score = "0/1";
          }
        } else {
          // 1 set
          game.infos.sets = Math.floor(Math.random() * 14)+"/"+Math.floor(Math.random() * 14);
