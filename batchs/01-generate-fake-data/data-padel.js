...
var generateFakeComment = function () {
  return [
   ...
   "C'est EXACTEMENT ça, Franchement pour dire ça faut vraiment être d'une mauvaise foi incomparable ou n'y rien connaitre au padel. On peut ne pas aimer Federer mais ne pas reconnaitre qu'il fait le show...",
...
var generateClubsAsync = function () {
  var names = ["CAEN TC", "CAEN LA BUTTE", "LOUVIGNY TC", "MONDEVILLE USO", "CONDE SUR NOIREAU TC", "ARROMANCHE padel PORT WILSON", "FLEURY padel CLUB"];
