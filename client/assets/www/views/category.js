  ...
  var CategoryView = Backbone.View.extend({
    ...
    entryExpanded:function() {
      ...
      if(expandedEntryId!=undefined) {
    	  zescore.routers.router.navigate("#"+Entries.lang+"/category/"+Entries.idCategory+"/entry/"+expandedEntryId,{replace: true});
        //Attach a collapsed handler
        expandedElement.on("collapse.expanded",function() {
        	zescore.routers.router.navigate("#"+Entries.lang+"/category/"+Entries.idCategory,{replace: true});
